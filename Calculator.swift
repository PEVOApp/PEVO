    ...
    */
    @IBAction func savePwd(sender: UIButton) {
        ...
        if isFirstTime == true {
            ...
            isFirstTime = false
            password.setBool(isFirstTime, forKey: "isFirstTime")
        }
            ...
            if displayLabel.text?.toInt() == myNumber
            {
    ...
    override func viewDidLoad() {
        ...
        Immidiately before release, uncomment the next line, run the app, but don't enter a passcode. Just to make sure.
        password.setBool(isFirstTime, forKey: "isFirstTime")
        */
